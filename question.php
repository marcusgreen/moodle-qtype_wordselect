...
class qtype_wordselect_question extends question_graded_automatically_with_countback {
    ...
    /** @var item[] the selectable items in the question text. */
    protected $items;
    /**
    ...
    public function get_words() {
        ...
        if (strpos($questiontextnodelim, $l . $l) !== false) {
            ...
            foreach ($matches as $key => $match) {
                $item = new item($key, $match, $this->delimitchars, true);
            ...
            foreach ($matches as $key => $text) {
                $item = new item($key, $text, $this->delimitchars, $this->multiword);
