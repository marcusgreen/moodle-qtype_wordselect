...
Feature: Test the basic functionality of wordselect type
    ...
    in Quiz editing page, but does it through quesiton preview. It only tests against the
    Interactive with multiple tries behaviour without question hints. A fuller test suite would cover
    with hints and with other question behaviours
