...
/**
 * Unit tests for the wordselect question type class.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/wordselect/questiontype.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_wordselect_test extends UnitTestCase {
    ...
    protected function setUp() {
        $this->qtype = new qtype_wordselect();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'wordselect');
    }
