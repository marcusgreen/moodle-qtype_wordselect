...
class qtype_wordselect_walkthrough_test extends qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_unanswered() {
        ...
        $wordselect = qtype_wordselect_test_helper::make_question('wordselect');
        $maxmark = 2;
        $this->start_attempt_at_question($wordselect, 'deferredfeedback', $maxmark);
    ...
    public function test_no_regex_or() {
        ...
        $wordselect = qtype_wordselect_test_helper::make_question2('wordselect', $questiontext, null, $options);
        $maxmark = 1;
            $this->start_attempt_at_question($wordselect, 'deferredfeedback', $maxmark);
        // Check the initial state.
        $this->check_current_state(question_state::$todo);
    ...
    public function test_deferred_with_blanks() {
        ...
        $wordselect = qtype_wordselect_test_helper::make_question2('wordselect', $questiontext);
        $maxmark = 2;
        $this->start_attempt_at_question($wordselect, 'deferredfeedback', $maxmark);
        // Check the initial state.
        $this->check_current_state(question_state::$todo);
    ...
    public function test_interactive_with_correct() {
        ...
        $wordselect = qtype_wordselect_test_helper::make_question('wordselect');
        $maxmark = 2;
        $this->start_attempt_at_question($wordselect, 'interactive', $maxmark);
    ...
    public function test_interactive_wildcard_with_correct() {
        // Create a wordselect question.
        $wordselect = qtype_wordselect_test_helper::make_question('wordselect', array('cat|dog', 'mat'));
        $maxmark = 2;
    ...
    public function test_disableregex() {
        ...
        $wordselect = qtype_wordselect_test_helper::make_question2('wordselect', $questiontext, false, $options);
        $this->start_attempt_at_question($wordselect, 'interactive', $wordselect->gapstofill);
    ...
    public function test_interactive_discard_duplicates() {
        ...
        /* Create a wordselect question and set noduplicates to true */
        $questiontext = '
...
[gold|silver|bronze]  ';
    ...
    public function test_interactive_grade_for_blank() {
        ...
        /* Create a wordselect question that gives a mark where one response
         * is designed to be blank, i.e. [!!] */
        $questiontext = '
 [one] sat on the [two] [!!] ';

        $wordselect = qtype_wordselect_test_helper::make_question2('wordselect', $questiontext, false);
    ...
    public function test_get_aftergap_text() {
        ...
        $wordselect = qtype_wordselect_test_helper::make_question2('wordselect', $questiontext);
        $maxmark = 2;
        $this->start_attempt_at_question($wordselect, 'immediatefeedback', $maxmark);
 ...
 [one] sat on the [two] [!!] ';
        ...
        $this->start_attempt_at_question($wordselect, 'deferredfeedback', $wordselect->gapstofill);
    ...
    public function test_get_gapsize() {
        $wordselect = qtype_wordselect_test_helper::make_question2('wordselect', "", false);
        $this->assertEquals($wordselect->get_size("one"), 3);
        $this->assertEquals($wordselect->get_size("one|twleve"), 6);
    }
